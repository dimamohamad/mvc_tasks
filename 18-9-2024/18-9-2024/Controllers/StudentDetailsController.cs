...
namespace _18_9_2024.Controllers
{
    public class StudentDetailsController : Controller
    {
        ...
        {
            ViewBag.StudentDetailID = new SelectList(db.Students, "StudentId", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "StudentDetailID,Address,PhoneNumber")] StudentDetails studentDetails)
        {
            ...
            ViewBag.StudentDetailID = new SelectList(db.Students, "StudentId", "Name", studentDetails.StudentDetailID);
            return View(studentDetails);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentDetailID,Address,PhoneNumber")] StudentDetails studentDetails)
        {
            if (ModelState.IsValid)
            {
